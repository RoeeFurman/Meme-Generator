...
// A tainted canvas is one which is no longer considered secure, 
// and any attempts to retrieve image data back from the canvas will cause an exception to be thrown
